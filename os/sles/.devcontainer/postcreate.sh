...
# ── Step 1: Download RCC ─────────────────────────────────────────────────────────
# registry.suse.com/suse/sle15:15.7 ships curl preinstalled (like Rocky,
# unlike Debian/Ubuntu) -- the guard below is a no-op here, kept for
# consistency across all four OSes and to protect against a future
# base-image change.

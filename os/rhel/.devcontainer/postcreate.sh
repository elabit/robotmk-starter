...
# ── Step 1: Download RCC ─────────────────────────────────────────────────────────
# rockylinux/rockylinux:10 ships curl preinstalled (unlike Debian/Ubuntu's
# stock images) -- the guard below is a no-op here, kept for consistency
# across all four OSes and to protect against a future base-image change.

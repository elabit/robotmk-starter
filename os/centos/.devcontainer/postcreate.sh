...
# quay.io/centos/centos:stream9 ships curl preinstalled (unlike Debian/Ubuntu's stock images) --
...
if ! command -v curl > /dev/null; then
  dnf -y install curl || fail "dnf install curl failed -- cannot download RCC."
fi
